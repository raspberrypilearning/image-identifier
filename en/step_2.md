...
This project will be completed on your computer, you'll use some starter code to set up the application for you, so you can focus on the machine learning part. First, you need to get that code and set it up. How you do this will vary based on your operating system.
